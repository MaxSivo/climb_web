...
• transformer.ipynb: Detailed implementation of the custom transformer architecture.
• hold2vec.ipynb: Explanation of the embedding technique used to represent Moonboard holds.
• climbgen+eda.ipynb: Logic behind the graph structure and the climb generation algorithm.
